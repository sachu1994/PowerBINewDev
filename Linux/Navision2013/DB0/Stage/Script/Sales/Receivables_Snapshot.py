    ...
    try:
        ...
        if dbe['ActiveInactive']=='true' and dbe==config["DbEntities"][0]:
            try:
                ...
                Path = HDFS_PATH+"/"+KockpitPath+"/"+DBName+"/"+EntityName+"/Stage2/ParquetData/Sales/Receivables_Snapshot"
            ...
            try:
                ...
                CompanyName=dbe['Location']+dbe['Name']
                CompanyName=CompanyName.replace(" ","")
                Path1 = HDFS_PATH+"/"+KockpitPath+"/"+DBName+"/"+EntityName+"/Stage2/ParquetData/Sales/Receivables_Snapshot"
