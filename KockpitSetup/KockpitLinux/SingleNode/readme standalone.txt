...
Step 2. When you open the terminal you are in the home directory. Download windows terminal from microsoft store
        and go to the location in Windows where your file is stored and right click on that file and open it the
        terminal and use command "scp -rv /OneClickStandalone.sh username@IP:/home/" (Secure Copy or SCP is a means
        of securley transferring files between two machines on a network.)


Step 3. Now type "bash OneClickStandalone.sh"

Step 4. After that enter your username of your master server. To know your linux server
...
Step 5. In the next step, Hadoop will be downloaded in your master server.
        ...
        Enter the number of slave servers you want to replicate your data.
        Because we are in the Standalone mode enter 1.

        The third prompt ask you for "Enter the master IP you want to add in your 
        hadoop master file :".
        Enter the master server IP.
        
        The fourth prompt ask you for "Enter the slave IP's you want to add in your 
        hadoop worker file :".
        Enter the slave server IP.

Step 6. Now, Spark will be installed in your system.
...
Step 7. After the spark installation it will move on to the Configuring SSH section. 
...
Step 8. Now it will move on to the "Adding Paths to .bashrc" section.
...
Step 9. Next prompt will ask you to install Delta Lake. 
...
Step 10. After adding paths to bashrc it will move on to the next section which is
...
Step 11.(In a new terminal)Type the command "source ~/.bashrc".
         and do again "bash OneClickStandalone.sh"
