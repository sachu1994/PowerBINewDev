    ...
    if dbe['ActiveInactive']=='true':
        ...
        try:
            ...
            for i in range(NoofRows):    
                ...
                Path = Abs_Path+"/"+DBName+"/"+EntityName+"\\Stage2\\ParquetData\\Master\Salesperson"
            ...
            try:
                ...
                IDEorBatch = "IDLE"
            os.system("spark-submit "+Kockpit_Path+"\Email.py 1 SalesPerson '"+CompanyName+"' "+DB0+" "+str(exc_traceback.tb_lineno)+"")    
